    ...
    <div className="flex items-center w-full h-full bg-cover bg-center" style={{backgroundImage:"url(main-bg.png)"}
      ...
      <div className="pl-20 md:pl-40 pb-56 md:pb-20 mt-40 flex flex-col gap-5 z-[10] max-w-[750px]">
        <h1 className="text-[50px] text-white font-semibold">
          Hi, I am Mathimalar<br></br> <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">Full Stack Developer</span>
        </h1>
        ...
        <div className="flex-col md:flex-row hidden md:flex gap-4">
          <Link href="/myskills" className="rounded-[20px] bg-blue-500 hover:bg-blue-400 px-5 py-3 text-lg text-white max-w-[200px]">
          Learn More</Link>
